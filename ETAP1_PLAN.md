...
- [ ] **1.1** Применить SQL-миграцию к Supabase (новые таблицы + ALTER операций)
- [ ] **1.2** Засеивание глобальных справочников (4 вида деятельности + 2 группы)
- [ ] **1.3** Обновить FastAPI (`server/main.py`):
  - [ ] Эндпоинты GET справочников (виды, группы, статьи, направления, контрагенты)
  - [ ] Эндпоинты CRUD статей ДДС / контрагентов / направлений
  - [ ] Обновить эндпоинт POST /operations: принимать article_id, direction_id, contragent_id, purpose
  - [ ] Обновить регистрацию: создавать 4 кошелька + базовые направления + базовые статьи
