...
async def cmd_start(message: types.Message):
    ...
    await message.answer(
        "👋 Здравствуйте! **MyCash** — управленческий учёт для вашего бизнеса и личных финансов.\n\n"
        "Главный вопрос предпринимателя в конце месяца: **сколько я реально заработал?** "
        "Деньги расходятся по счетам и кассам, и чистая прибыль теряется в этой суете — её неделями не сосчитать.\n\n"
        "MyCash наводит порядок:\n\n"
        "💰 **Сколько денег сейчас** — по всем счетам сразу, в одном экране\n"
        "✅ **Чистая прибыль за месяц** — видна в тот же день, а не неделями позже\n"
        "🧭 **Деньги по направлениям** — какое приносит прибыль, а какое тянет вниз\n"
        "📈 **Отчёт о движении денег** — было, что изменилось, сколько осталось\n\n"
        "Просто, наглядно и без сложных таблиц.\n\n"
