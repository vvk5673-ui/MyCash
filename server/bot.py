...
async def cmd_start(message: types.Message):
    ...
    await message.answer(
        "👋 Здравствуйте! Я **MyCash** — ваш помощник в учёте финансов бизнеса.\n\n"
        "Держите деньги под контролем:\n\n"
        "📊 Доходы и расходы по направлениям бизнеса\n"
        "📈 Отчёт о движении денежных средств (ДДС)\n"
        "🗓 Итоги за любой период — день, месяц, год\n\n"
