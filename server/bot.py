...
WEBAPP_URL = "https://vvk5673-ui.github.io/MyCash/?v=70"
...
async def cmd_start(message: types.Message):
    ...
    await message.answer(
        "👋 Здравствуйте! <b>MyCash</b> — управленческий учёт для вашего бизнеса и личных финансов.\n\n"
        "Главный вопрос предпринимателя в конце месяца: <b>сколько я реально заработал?</b> "
        "Деньги расходятся по счетам и кассам, и чистая прибыль теряется в этой суете — <i>её неделями не сосчитать.</i>\n\n"
        "<b>MyCash наводит порядок:</b>\n\n"
        "💰 <b>Сколько денег сейчас</b> — по всем счетам сразу, в одном экране\n"
        "✅ <b>Чистая прибыль за месяц</b> — видна в тот же день, <i>а не неделями позже</i>\n"
        "🧭 <b>Деньги по направлениям</b> — какое приносит прибыль, а какое тянет вниз\n"
        "📈 <b>Отчёт о движении денег</b> — было, что изменилось, сколько осталось\n\n"
        "<i>Просто, наглядно и без сложных таблиц.</i>\n\n"
        "Нажмите кнопку ниже — и увидите свои деньги как на ладони 👇",
